...
<Stack className="projectsboxed" gap="10px"  marginTop="17%" marginLeft="30px">
...
<Box  height="265px" borderRadius="30px 0px"  className="travelbox" width="305px" marginTop="10px"  boxShadow="0px 0px 12px 0px #FFF;" >
<div data-aos="zoom-in">
<img  style={{width:"100%",padding:"13px",margin:"auto"}} src={travels} alt="" />
<Typography color="white" textAlign="center" variant="h5" fontFamily="Monospace">
    Global-travel
</Typography>
...
<Box  height="272px"  borderRadius="30px 0px"  className="megabox" width="300px"   boxShadow=" 0px 0px 12px 0px #FFF" >
<div data-aos="zoom-in">
...
<Box  height="265px"  borderRadius="30px 0px"  className="megabox" width="300px"   boxShadow=" 0px 0px 12px 0px #FFF" >
<div data-aos="zoom-in">
<img style={{width:"100%",padding:"10px",marginTop:"16px"}} src={arch} alt="" />
<Typography marginTop="22px" color="white" textAlign="center" variant="h5" fontFamily="Monospace">
Arch-Baku
</Typography>
<Box margin="0 auto" marginTop="12px" border="1px solid" width='200px'>
